...
// Source: github.com/ilya-rusyanov/shrinklator/internal/handlers (interfaces: Pinger)
//
// Generated by this command:
//
//	mockgen --build_flags=--mod=mod -package mocks -destination ./mocks/mock_pinger.go . Pinger
//
