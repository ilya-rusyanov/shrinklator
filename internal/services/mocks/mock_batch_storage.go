...
//
//	mockgen --build_flags=--mod=mod -package mocks -destination ./mocks/mock_batch_storage.go . BatchStorage
//
...
func (mr *MockBatchStorageMockRecorder) PutBatch(arg0, arg1 any) *gomock.Call {
